...
\begin{ex}\label{sinecurvesketckex01}   Let $f(x) = 2 \sin(x) - \sin(2x)$ restricted to the interval $[0, 2\pi]$.
...
\begin{ex}\label{IPexamplecosine}  Let  $f(x) = x-2\cos(x)$ restricted to the interval  $0 \leq x \leq 2\pi$.   
