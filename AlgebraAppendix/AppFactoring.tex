...
\colorbox{ResultColor}{\bbm \begin{definition}\label{irreduciblepoly}  A polynomial is said to be \textbf{irreducible}\index{polynomial ! irreducible} if it cannot be written as the product of polynomials of lower degree.
\end{definition}
\ebm}
...
\begin{example}\label{FormulaFactoring}  Factor the following polynomials completely over the rationals.  That is, write each polynomial as a product polynomials of lowest degree which are irreducible over the rationals. 
...
\begin{example}\label{solveeqnbyfactoring}  Solve the following equations.
...
%% SKIPPED %% \input{ExercisesforAppFactoring}
