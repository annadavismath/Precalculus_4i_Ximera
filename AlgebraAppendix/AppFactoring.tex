...
\begin{definition}\label{irreduciblepoly}  A polynomial is said to be \textbf{irreducible}\index{polynomial ! irreducible} if it cannot be written as the product of polynomials of lower degree.
\end{definition}
%% \ebm}
