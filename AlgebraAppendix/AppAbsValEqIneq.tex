...
%% \colorbox{ResultColor}{\bbm
\begin{theorem}  \textbf{Properties of Absolute Value:} Let $a$ and $b$ be real numbers and let $n$ be an integer.\footnote{See page \pageref{setsofnumbersboxonthispage} if you don't remember what an integer is.} \index{absolute value ! properties of}\label{absolutevalueprops} 
...
%% \colorbox{ResultColor}{\bbm
\begin{theorem}  \label{absolutevalueineq} \textbf{Inequalities Involving Absolute Value:}  Let $c$ be a real number. \index{inequality ! absolute value} \index{absolute value ! inequality}
...
%% SKIPPED %% \input{ExercisesforAppAbsValEqIneq}
