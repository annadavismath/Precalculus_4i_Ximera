...
\item\label{findbothformulaquadgraphfirst} $~$  %$f(x) = x^2 - 3$
...
\item\label{findbothformulaquadgraphlast} $~$ %$s(t) = -\frac{1}{3}(t-2)^2 + \frac{4}{3}= -\frac{1}{3} t^2 + \frac{4}{3} t$
...
\item\label{SasquatchShirts}The cost, in dollars, to produce $x$ ``I'd rather be a Sasquatch'' T-Shirts is $C(x) = 2x+26$, $x \geq 0$ and the price-demand function, in dollars per shirt,  is $p(x) = 30 - 2x$, for $0 \leq x \leq 15$. \label{maxprofitfirst}
