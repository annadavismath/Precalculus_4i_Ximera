...
\title{\Huge \underline{Pre}Calculus  \\ \vspace{.1in} \large Edition $4i$  \\ \vspace{.25in} \large based on the original work by}
...
\chapter{First Steps into Calculus}
\label{FirstStepsCalculus}
\thispagestyle{empty}
\import{./FirstStepsCalculus/}{FirstStepsCalculus}
