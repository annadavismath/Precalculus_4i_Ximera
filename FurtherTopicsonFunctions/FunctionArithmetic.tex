...
\begin{ex}\label{marginalsetupex}  The cost, in dollars,  $C(x)$, to produce $x$ `PortaBoy' handheld game systems is given by:  $C(x) = .03x^{3} - 4.5x^{2} + 225x + 250$.   The revenue generated by selling $x$  of the systems, $R(x)$, also in dollars, is given by $R(x) = -1.5x^2 + 250x$.
